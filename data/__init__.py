...
def create_cd_dataloader(dataset, dataset_opt, phase,sampler=None,collate_fn=None):
...
def create_cd_dataset(dataset_opt, phase,type='semantic'):
    from data.CDDataset import CDDataset,SemanticCDDataset
    if type == 'semantic':
        dataset = SemanticCDDataset(root_dir=dataset_opt["datasetroot"],
