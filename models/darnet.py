...
class DARNet(nn.Module):
    ...
    def forward(self, inputs_t1, inputs_t2):
        ...
        h1_t1 = self.conv1(inputs_t1)  

        h2_t1 = self.maxpool1(h1_t1)
        h2_t1 = self.conv2(h2_t1)  

        h3_t1 = self.maxpool2(h2_t1)
        h3_t1 = self.conv3(h3_t1)  

        h4_t1 = self.maxpool3(h3_t1)
        h4_t1 = self.conv4(h4_t1)  

        h5_t1 = self.maxpool4(h4_t1)
        hd5_t1 = self.conv5(h5_t1)  

        
        h1_t2 = self.conv1(inputs_t2)  

        h2_t2 = self.maxpool1(h1_t2)
        h2_t2 = self.conv2(h2_t2)  

        h3_t2 = self.maxpool2(h2_t2)
        h3_t2 = self.conv3(h3_t2)  

        h4_t2 = self.maxpool3(h3_t2)
        h4_t2 = self.conv4(h4_t2)  

        h5_t2 = self.maxpool4(h4_t2)
        hd5_t2 = self.conv5(h5_t2)  
        ...
        hd4 = self.relu4d_1(self.bn4d_1(self.conv4d_1(AB_4d)))  
        ...
        hd3 = self.relu3d_1(self.bn3d_1(self.conv3d_1(AB_3d)))  
        ...
        hd2 = self.relu2d_1(self.bn2d_1(self.conv2d_1(AB_2d)))  
        ...
        hd1 = self.relu1d_1(self.bn1d_1(self.conv1d_1(AB_1d)))  
        ...
        return d5_up, d4_up, d3_up, d2_up, d1  
