...
if __name__ == '__main__':
    net = swin_base_patch4_window7_224_in22k(num_classes=21841)
    path = r"/data02/zht_vqa/change_detection/backbone/swin_base_patch4_window7_224_22k.pth"
