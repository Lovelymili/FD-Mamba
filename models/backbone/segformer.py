...
import math
from models.backbone.SeparableCov import SeparableConv1d
...
class Segformer_restar(nn.Module):
    def __init__(self, backbone="mit_b5"):
        super(Segformer_restar, self).__init__()
        if backbone == "mit_b0":
    ...
    def forward(self, x1, x2):
        ...
        segmap_small = self.head(diff_list) 
...
if __name__ == "__main__":
    ...
    seg = Segformer_restar(backbone="mit_b0")
